...
#define BP_ENDOFINPUT   1
                           ...
                           // Decimal 12
#define BP_CR         '\n' // Decimal 13  POSTFIX -
#define BP_ELSE        '!' // Decimal 33  POSTFIX
#define BP_STRING      '"' // Decimal 34
#define BP_REM         '#' // Decimal 35
// VARIABLE IN BIPLAN   $     Decimal 36
#define BP_MOD         '%' // Decimal 37  POSTFIX -
#define BP_AND         '&' // Decimal 38  POSTFIX -
                           // Decimal 39
#define BP_L_RPARENT   '(' // Decimal 40
#define BP_R_RPARENT   ')' // Decimal 41  POSTFIX
#define BP_MULT        '*' // Decimal 42  POSTFIX -
#define BP_PLUS        '+' // Decimal 43  POSTFIX -
#define BP_COMMA       ',' // Decimal 44  POSTFIX -
#define BP_MINUS       '-' // Decimal 45  POSTFIX -
                           // Decimal 46
#define BP_DIV         '/' // Decimal 47  POSTFIX -
...
#define BP_SEMICOLON   ';' // Decimal 59  POSTFIX -
#define BP_LT          '<' // Decimal 60  POSTFIX -
// EQUALS TO            =     Decimal 61
#define BP_GT          '>' // Decimal 62  POSTFIX -
#define BP_IF          '?' // Decimal 63
#define BP_FOR         '@' // Decimal 64
#define BP_LOGIC_AND   'A' // Decimal 65  POSTFIX -
#define BP_BREAK       'B' // Decimal 66
#define BP_DECREMENT   'C' // Decimal 67  POSTFIX -
#define BP_DELAY       'D' // Decimal 68
#define BP_DWRITE      'E' // Decimal 69
#define BP_ENDIF       'F' // Decimal 70
#define BP_DREAD       'G' // Decimal 71
#define BP_GTOEQ       'H' // Decimal 72  POSTFIX -
#define BP_LTOEQ       'I' // Decimal 73  POSTFIX -
#define BP_AGET        'J' // Decimal 74  POSTFIX -
#define BP_R_SHIFT     'K' // Decimal 75  POSTFIX -
#define BP_L_SHIFT     'L' // Decimal 76  POSTFIX -
#define BP_MILLIS      'M' // Decimal 77
#define BP_BITWISE_NOT 'N' // Decimal 78  POSTFIX
#define BP_LOGIC_OR    'O' // Decimal 79  POSTFIX
#define BP_PINMODE     'P' // Decimal 80
#define BP_EQ          'Q' // Decimal 81  POSTFIX
#define BP_RND         'R' // Decimal 82
#define BP_STR_ACCESS  'S' // Decimal 83
#define BP_NOT_EQ      'T' // Decimal 84  POSTFIX
                           // Decimal 85
#define BP_VAR_ACCESS  'V' // Decimal 86
                           ...
                           // Decimal 89
                           // Decimal 90
#define BP_ACCESS      '[' // Decimal 91  POSTFIX
// BACKSLASH                  Decimal 92
#define BP_ACCESS_END  ']' // Decimal 93  POSTFIX
#define BP_XOR         '^' // Decimal 94  POSTFIX
                     // _     Decimal 95
#define BP_INCREMENT   '`' // Decimal 96  POSTFIX
#define BP_SERIAL_AV   'a' // Decimal 97
#define BP_CHAR        'b' // Decimal 98
#define BP_CONTINUE    'c' // Decimal 99
                           // Decimal 100
#define BP_INPUT       'e' // Decimal 101 POSTFIX
#define BP_FUN_DEF     'f' // Decimal 102
#define BP_SERIAL_TX   'g' // Decimal 103
                           // Decimal 104
#define BP_INPUT_AV    'i' // Decimal 105 POSTFIX
                           // Decimal 106
                           // Decimal 107
                           // Decimal 108
#define BP_SIZEOF      'm' // Decimal 109
#define BP_NEXT        'n' // Decimal 110
#define BP_REDO        'o' // Decimal 111
#define BP_PRINT       'p' // Decimal 112
#define BP_STOI        'q' // Decimal 113
#define BP_RETURN      'r' // Decimal 114
#define BP_SQRT        's' // Decimal 115
#define BP_S_ADDRESS   't' // Decimal 116 POSTFIX
#define BP_SERIAL_RX   'u' // Decimal 117
#define BP_ADDRESS     'v' // Decimal 118 POSTFIX
#define BP_WHILE       'w' // Decimal 119
#define BP_END         'x' // Decimal 120 POSTFIX
                           // Decimal 121
#define BP_RESTART     'z' // Decimal 122 POSTFIX
#define BP_BLOCK       '{' // Decimal 123
#define BP_OR          '|' // Decimal 124 POSTFIX
#define BP_BLOCK_END   '}' // Decimal 125 POSTFIX
#define BP_FUNCTION    '~' // Decimal 126 POSTFIX
                           // Decimal 127

#define BP_NUMBER     128

// #define BP_AWRITE Analog
