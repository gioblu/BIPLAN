...
For now BIPLAN is around 1.6 times slower than python on my linux machine and around 10 times quicker than TinyBasicPlus when running on Arduino compatible boards.
